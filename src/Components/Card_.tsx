...
import { Container,
    ...
    import mundo_img from '../img/icon_gis.png'
    import ol_img from '../img/logo_openlayers.png'
    ...
    <div>
      ...
      <Flex
        ...
        <chakra.p fontFamily={'Work Sans'} fontWeight={'bold'} fontSize={14}>
          {"OpenLayers es una biblioteca de JavaScript de código abierto la cual permite crear mapas dinámicos en cualquier página web "}
          {/* <chakra.span
            fontFamily={'Inter'}
            fontWeight={'medium'}
            color={'gray.500'}>
